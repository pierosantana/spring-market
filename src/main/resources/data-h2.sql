...
-- COMPRA
INSERT INTO compras VALUES (1, '4546221', TIMESTAMP '1992-08-10 17:30:00', 'E', '', 'P');
...
-- Reiniciar las "secuencias" de auto_increment
ALTER TABLE PRODUCTOS ALTER COLUMN id_producto RESTART WITH 51;
ALTER TABLE CATEGORIAS ALTER COLUMN id_categoria RESTART WITH 9;
ALTER TABLE COMPRAS ALTER COLUMN id_compra RESTART WITH 2;
